...
public enum ErrorCode {
    ...
    PRODUCT_SOLD_OUT(HttpStatus.CONFLICT, "상품이 품절되었습니다."),
    PRODUCT_UNAVAILABLE(HttpStatus.CONFLICT, "상품을 구매할 수 없습니다."),
    ...
    ORDER_REQUEST_IN_PROGRESS(HttpStatus.CONFLICT, "주문 요청을 처리하고 있습니다."),
    IDEMPOTENCY_KEY_REUSED(HttpStatus.CONFLICT, "동일한 멱등성 키를 다른 요청에 사용할 수 없습니다."),
