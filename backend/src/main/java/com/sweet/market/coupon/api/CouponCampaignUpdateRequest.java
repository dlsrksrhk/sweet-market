...
public record CouponCampaignUpdateRequest(
    ...
    public boolean isValidityPolicyValid() { if (validityType == null) return true; return validityType == CouponValidityType.COMMON_EXPIRY ? commonExpiresAt != null && validityDays == null : commonExpiresAt == null && validityDays != null; }
