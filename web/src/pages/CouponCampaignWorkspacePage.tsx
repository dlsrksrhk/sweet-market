...
export function issueAvailabilityText(campaign: { issueLimit: number | null; issuedCount: number; remainingIssueCount: number | null }) { return campaign.issueLimit === null ? '발급 무제한' : `발급 ${campaign.issuedCount} / ${campaign.issueLimit} · 잔여 ${campaign.remainingIssueCount}`; }
